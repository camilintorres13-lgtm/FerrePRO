...
// ─── TopBar ────────────────────────────────────────────────────────────────────
function TopBar({ sideW, search, onSearch }) {
  return (
    <header className="w-full top-0 sticky z-40 bg-white/80 backdrop-blur-md shadow-[0_8px_24px_rgba(26,28,28,0.06)] transition-all duration-300" style={{ paddingLeft: sideW }}>
      <div className="flex items-center justify-between px-6 py-3">
        <div className="flex items-center gap-6">
          <span className="text-xl font-bold tracking-tight text-zinc-900" style={{ fontFamily: "Manrope, sans-serif" }}>
            Orders Management
          </span>
          <div className="relative">
            ...
            <input
              ...
              className="bg-zinc-100 border-none rounded-full py-2 pl-10 pr-4 w-72 focus:outline-none focus:ring-2 focus:ring-orange-500/20 text-sm transition-all"
              placeholder="Search orders, clients, IDs..."
            />
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button className="p-2 rounded-full hover:bg-zinc-100 transition-colors text-zinc-500 active:scale-95">
          ...
          <img
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAt4-CGlTj_aGhDHMu9NVEJcucw955tV1KXkSXa7tfwih_Jsvzgi6l_iy11TKvjmnh0IakwpDcHUuoG4acTGhbGdze8mxkPDghG4GbxFEeHN5YVX3KMb9qARKxEW15NTLnofG2zJvo-_mskrBnoOMwpVldOSOwMY0tsnh38cUBVlm_SsCUrHJQX3pdfai1x_jhnaEt9Hx5dPTFEV0Nc4eVuag000iEn9Vwnpn-9utdszFn-L6jVxjd0TI76R2eECbW2WP2ikd3Xo6nx"
            alt="Admin"
...
export default function OrdenesPage() {
  ...
  return (
    <div className="bg-zinc-50 text-zinc-900 min-h-screen" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <TopBar sideW={sideW} search={search} onSearch={setSearch} />
